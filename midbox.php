...
.a{
 ...
 <div class="row"  >
	 <div class="col-sm-9" style="text-align:justify;margin-bottom:20px;">
	 <h2>About Us</h2>
	 <hr>
	 <div class="a">
     ...
     For any queries/information, do write to us: <a href="mailto:aao@hijli.iitkgp.ernet.in">aao@hijli.iitkgp.ernet.in</a>
	 </div>
	 </div>
	 <div  class="col-sm-3" >
	  <h3>Testimonials</h3>
